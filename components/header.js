  ...
  return (
    <div>
      ...
      <Row
        className={
          navbar
            ? "flex justify-center 1150:space-x-[450px] mlg:justify-between items-center h-[80px] 1150:px-[20px] px-[40px] bg-white shadow-lg w-[100%]"
      ...
      <Menu
        className={
          visible
            ? "1150:hidden flex flex-col absolute z-[999] left-0 bottom-[-220px] w-[100%] shadow-lg h-[220px] bg-white divide-y divide-solid"
            : "hidden"
        }
      >
        {/* {menuList.map((item) => (
        ...
        <Menu.Item className="pl-[10px] py-[7px]">
          <Link href="/">
            <a className="text-sm flex items-center max-w-[200px] space-x-[20px]">
              <HomeFilled />
              <h1>Home</h1>
        ...
        <Menu.Item
          className="pl-[10px] cursor-pointer py-[7px]"
          onClick={() => setDropDown(!dropDown)}
        >
          <a className="text-sm flex items-center max-w-[200px] space-x-[20px] relative">
            <CodepenCircleFilled />
            <h1>Our Offerings</h1>
            <CaretDownOutlined className="absolute right-[60px]" />
          </a>
        </Menu.Item>
        {dropDown && (
          <Menu className="divide-y divide-solid">
            <Menu.Item>
              <Link href="/solutions">
                <a className="text-sm items-center max-w-[200px] space-y-[5px] pl-[70px] py-[5px]">
                  Solutions
                </a>
              </Link>
            </Menu.Item>
